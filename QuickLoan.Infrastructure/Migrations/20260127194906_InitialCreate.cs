        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BlacklistedDomains_Users_BlockedByUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BlacklistedMobiles_Users_BlockedByUserId",
                        column: x => x.BlockedByUserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ApplicationUrl = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BlacklistedDomains_BlockedByUserId",
                table: "BlacklistedDomains",
                column: "BlockedByUserId");

            migrationBuilder.CreateIndex(
                name: "IX_BlacklistedMobiles_BlockedByUserId",
                table: "BlacklistedMobiles",
                column: "BlockedByUserId");

            migrationBuilder.CreateIndex(
                name: "IX_LoanApplications_ApplicationUrl",
